...
export const getFood = (foodId) => async (dispatch) => {
  try {
    const Food = await axios({
      method: "GET",
      url: `https://zomato-clonhttps://zomato-clone-heroku-backend2.herokuapp.com/e-heroku-backend.herokuapp.com/food/${foodId}`,
    });
...
export const getFoodList = (menuId) => async (dispatch) => {
  try {
    const Menu = await axios({
      method: "GET",
      url: `https://zomato-clone-heroku-backend2.herokuapp.com//menu/list/${menuId}`,
    });
